		...
		get = function(self, player, context)
			...
			return sfinv.make_formspec(player, context,
				...
				[[
					...
					listring[]
					list[current_player;craft;6.2,0.2;3,3;]
					list[current_player;craftpreview;11,1.2;1,1;]
					image[9.5,1.2;1,1;gui_furnace_arrow_bg.png^[transformR270]
				...
				default.get_hotbar_bg(4.8,6.9) .. creative.formspec_add, false)
		end,
